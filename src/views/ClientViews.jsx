...
import { ShoppingBag, User, MapPin, Phone, Mail, Calendar, Package, Truck, CheckCircle, Clock, Edit, LogOut, ChevronRight } from 'lucide-react';

// Datos quemados para Cliente
const clientOrdersData = [
    { id: 'CLI-001', date: '2024-01-25', items: [{ name: 'Sistema GOLIATH', qty: 1, price: 85000 }], total: 85000, status: 'delivered', tracking: 'RW12345CR' },
    { id: 'CLI-002', date: '2024-01-20', items: [{ name: 'Sistema VELOX', qty: 1, price: 78000 }, { name: 'Plantilla LeapCore™', qty: 2, price: 45000 }], total: 168000, status: 'shipped', tracking: 'RW12346CR' },
    { id: 'CLI-003', date: '2024-01-15', items: [{ name: 'Sistema ORBIS', qty: 1, price: 72000 }], total: 72000, status: 'processing', tracking: null },
    { id: 'CLI-004', date: '2024-01-10', items: [{ name: 'Sistema LEOPARD', qty: 1, price: 82000 }], total: 82000, status: 'delivered', tracking: 'RW12340CR' },
];
