                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        <section>
                            ...
                            <div className="space-y-4">
                                <div className="p-6 border-2 border-[#75CBB3] rounded-2xl flex items-center gap-4 bg-[#75CBB3]/5">
                                    <div className="w-4 h-4 rounded-full border-4 border-[#75CBB3] bg-white"></div>
                    ...
                    <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white shadow-2xl sticky top-32">
                            ...
                            {cartItems.map((item, idx) => (
                                <div key={idx} className="flex justify-between items-center text-xs">
                                    <div>
                                        ...
                                        <p className="text-slate-500 font-bold uppercase tracking-tighter">1 UNIDAD</p>
                                    </div>
                        ...
                        <div className="border-t border-white/10 pt-6 space-y-4">
                            ...
                            <div className="flex justify-between text-xl font-black pt-4 border-t border-white/10">
                                <span>TOTAL</span>
                                <span className="text-[#75CBB3]">${total}</span>
                            </div>
                        </div>
